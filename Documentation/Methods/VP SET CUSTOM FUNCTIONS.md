...
>* As soon as `VP SET CUSTOM FUNCTIONS` is called, the methods allowed by the [VP SET ALLOWED METHODS](VP%20SET%20ALLOWED%20METHODS.md) command (if any) are ignored in the 4D View Pro area.
...
[VP SET ALLOWED METHODS](VP%20SET%20ALLOWED%20METHODS.md)<br/>
