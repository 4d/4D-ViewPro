...
If you export your document to an object using [VP Export to object](VP%20Export%20to%20object.md), or to a 4DVP document using [VP EXPORT DOCUMENT](VP%20EXPORT%20DOCUMENT.md), the `includeBindingSource` option lets you copy the contents of the current contexts as cell values in the exported object or document. For more details, refer to the description of those methods.
...
![](../images/vp-set-data-context-2.png)
...
![](../images/vp-set-data-context-3.png)
