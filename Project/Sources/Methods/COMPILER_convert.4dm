...
If (False:C215)
	...
	C_OBJECT:C1216(convert_printSettings; $2)
	...
	// ----------------------------------------------------
	C_OBJECT:C1216(convert_ensureRect; $1)
	C_LONGINT:C283(convert_ensureRect; $2)
	C_LONGINT:C283(convert_ensureRect; $3)
	
	// ----------------------------------------------------
	C_OBJECT:C1216(convert_apply_styleRanges; $1)
