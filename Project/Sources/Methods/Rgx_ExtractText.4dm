...
/*
Long Integer := ***Rgx_ExtractText*** ( Param_1 ; Target ; Param_3 ; Param_4 ; Options )
 -> Param_1 (Text)
 -> Target (Text)
 -> Param_3 (Text)
 -> Param_4 (Pointer)
...
C_LONGINT:C283($Lon_Current_Group;$Lon_Groups;$Lon_i;$Lon_Index;$Lon_Index_Group;$Lon_Options;$nbParameters;$Lon_Start)
