...
If (Asserted:C1132($nbParameters>=1;"Missing parameter"))
	...
	End if 
	  ...
	  // Ignored keys [
	APPEND TO ARRAY:C911($tTxt_ignoredProperties;"locked")
	APPEND TO ARRAY:C911($tTxt_ignoredProperties;"visible")
	...
	APPEND TO ARRAY:C911($tTxt_ignoredProperties;"backColorEven")
	...
	APPEND TO ARRAY:C911($tTxt_ignoredProperties;"minusColorOdd")
	  //APPEND TO ARRAY($tTxt_ignoredProperties;"hAlign")
	  //APPEND TO ARRAY($tTxt_ignoredProperties;"vAlign")
	  //APPEND TO ARRAY($tTxt_ignoredProperties;"rotation")
	APPEND TO ARRAY:C911($tTxt_ignoredProperties;"wordWrap")
	APPEND TO ARRAY:C911($tTxt_ignoredProperties;"forceTextFormat")
